 ...
 */
$labels = array(
  'name'                  => _x( 'Key-concepts', 'Post Type General Name', 'text_domain' ),
  'singular_name'         => _x( 'Key-concept', 'Post Type Singular Name', 'text_domain' ),
  'menu_name'             => __( 'Key-concepts', 'text_domain' ),
  'name_admin_bar'        => __( 'Key-concepts', 'text_domain' ),
  'archives'              => __( 'Item Archives', 'text_domain' ),
  'attributes'            => __( 'Item Attributes', 'text_domain' ),
  'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
  'all_items'             => __( 'All Key-concepts', 'text_domain' ),
  'add_new_item'          => __( 'Add New Key-concept', 'text_domain' ),
  'add_new'               => __( 'Add New', 'text_domain' ),
  'new_item'              => __( 'New Key-concept', 'text_domain' ),
  'edit_item'             => __( 'Edit Key-concept', 'text_domain' ),
  'update_item'           => __( 'Update Key-concept', 'text_domain' ),
  'view_item'             => __( 'View Key-concept', 'text_domain' ),
  'view_items'            => __( 'View Key-concepts', 'text_domain' ),
  'search_items'          => __( 'Search Key-concept', 'text_domain' ),
  'not_found'             => __( 'Not found', 'text_domain' ),
  'not_found_in_trash'    => __( 'Not found in Trash', 'text_domain' ),
  'featured_image'        => __( 'Featured Image', 'text_domain' ),
  'set_featured_image'    => __( 'Set featured image', 'text_domain' ),
...
$args = array(
  'label'                 => __( 'Key-concept', 'text_domain' ),
  'description'           => __( 'Digital Textualities Key-concepts', 'text_domain' ),
  'labels'                => $labels,
  'supports'              => array( 'title', 'editor' ),
  'hierarchical'          => false,
  'public'                => true,
...
register_post_type( 'key_concept', $args );
 ...
 */
$labels = array(
  'name'                  => _x( 'Research topics', 'Post Type General Name', 'text_domain' ),
  'singular_name'         => _x( 'Research topic', 'Post Type Singular Name', 'text_domain' ),
  'menu_name'             => __( 'Research topics', 'text_domain' ),
  'name_admin_bar'        => __( 'Research topics', 'text_domain' ),
  'archives'              => __( 'Item Archives', 'text_domain' ),
  'attributes'            => __( 'Item Attributes', 'text_domain' ),
  'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
  'all_items'             => __( 'All Research topics', 'text_domain' ),
  'add_new_item'          => __( 'Add New Research topic', 'text_domain' ),
  'add_new'               => __( 'Add New', 'text_domain' ),
  'new_item'              => __( 'New Research topic', 'text_domain' ),
  'edit_item'             => __( 'Edit Research topic', 'text_domain' ),
  'update_item'           => __( 'Update Research topic', 'text_domain' ),
  'view_item'             => __( 'View Research topic', 'text_domain' ),
  'view_items'            => __( 'View Research topics', 'text_domain' ),
  'search_items'          => __( 'Search Research topic', 'text_domain' ),
  'not_found'             => __( 'Not found', 'text_domain' ),
  'not_found_in_trash'    => __( 'Not found in Trash', 'text_domain' ),
  'featured_image'        => __( 'Featured Image', 'text_domain' ),
  'set_featured_image'    => __( 'Set featured image', 'text_domain' ),
...
$args = array(
  'label'                 => __( 'Research topic', 'text_domain' ),
  'description'           => __( 'Digital Textualities Research topics', 'text_domain' ),
  'labels'                => $labels,
  'supports'              => array( 'title', 'editor' ),
  'hierarchical'          => false,
  'public'                => true,
...
register_post_type( 'research_topic', $args );
